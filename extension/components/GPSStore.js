...
GPSStore.prototype = {
	...
	var query = 'SELECT file, date, pilot, glider, country, site, landing, synchro FROM flights WHERE strftime("%Y-%m", date, "unixepoch", "localtime")=?1 XXX ORDER BY date DESC';
